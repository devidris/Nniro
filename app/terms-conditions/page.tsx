...
function TermsPage({}) {
  ...
  return (
    <div
      className="p-4 w-full max-w-7xl mx-auto no-scrollbar overflow-y-auto text-base text-gray-500 prose"
    ...
    >
      ...
      <p>
        ...
        of Nniro's Website, located at https://nniro.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Nniro if you do not agree to take all
      ...
      <p>
        Unless otherwise stated, Nniro and/or its licensors own the intellectual
        property rights for all material on Nniro. All intellectual property
        rights are reserved. You may access this from Nniro for your own
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Nniro
        ...
        of Nniro,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Nniro shall not be liable for the Comments
      ...
      <p>
        ...
        e-mail to Nniro. Please include your name, your organization name,
