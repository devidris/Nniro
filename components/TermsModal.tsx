...
const TermsModal = () => {
  ...
  return (
    <Modal title="Terms and Conditions" onClose={onClose} isOpen={isOpen}>
      <div className="p-4 max-h-[450px] overflow-y-auto text-base text-gray-500 prose">
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>

        <p>Welcome to Nniro!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Nniro's Website, located at https://nniro.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Nniro if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing Nniro, you agreed to use
          cookies in agreement with the Nniro's Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Nniro and/or its licensors own the
          intellectual property rights for all material on Nniro. All
          intellectual property rights are reserved. You may access this from
          Nniro for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Nniro</li>
          <li>Sell, rent or sub-license material from Nniro</li>
          <li>Reproduce, duplicate or copy material from Nniro</li>
          <li>Redistribute content from Nniro</li>
        </ul>
        ...
        <p>
          ...
          Nniro does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of Nniro,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Nniro shall not be liable for
        ...
        <p>
          Nniro reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Nniro a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of Nniro; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to Nniro. Please include your name, your
        ...
        <p>
          No use of Nniro's logo or other artwork will be allowed for linking
